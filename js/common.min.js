...
module.exports = function () {
	...
	_createClass(Common, [{
		...
		key: 'catalogSwitcherCtrl',
		value: function catalogSwitcherCtrl() {
			$('.catalog-view__btn_3').on('click', function () {
				$('.catalog-view__btn').removeClass('active');
				$(this).addClass('active');
				$('.catalog-page__goods').removeClass('catalog-page__goods_4');
			});
			$('.catalog-view__btn_4').on('click', function () {
				$('.catalog-view__btn').removeClass('active');
				$(this).addClass('active');
				$('.catalog-page__goods').removeClass('catalog-page__goods_3');
				$('.catalog-page__goods').addClass('catalog-page__goods_4');
			});
		}
	}, {
